package com.akshitbaunthy.labspringassignmentsolution.controller;
...
import com.akshitbaunthy.labspringassignmentsolution.service.StudentService;
...
public class StudentController {
    ...
    public String saveBook(@RequestParam("id") int id, @RequestParam("firstName") String firstName, @RequestParam("lastName") String lastName, @RequestParam("course") String course, @RequestParam("country") String country) {
        ...
        } else theStudent = new Student(firstName, lastName, course, country);
        // save the Book
